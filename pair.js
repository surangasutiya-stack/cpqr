...
const config = {
  ...
  PREFIX: '.',
  MAX_RETRIES: 3,
  GROUP_INVITE_LINK: 'https://chat.whatsapp.com/LrRAeEBvE8e8Arx34EEAY0?mode=hqrc',
...
case 'menu': {
  ...
  try {
    ...
    const GIF_URL  = 'https://files.catbox.moe/your_gif_video.mp4'; // mp4 gif-style
